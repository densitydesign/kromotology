...
angular.module('kromotologyApp')
  .controller('MainCtrl', function ($scope,$http) {
	...
	$scope.fetchColors = function(){
		...
		// Old asyncronous function for the API call
		// $scope.listToParse.forEach(function(url,i){
		...
		// 			}
		// 		}, function(error){
		// 			console.log('error for this url: ', url)
		// 			$scope.errors++
		// 			error.config.id = i
	...
	$scope.recursiveFetch = function(position){
		if(position < $scope.listToParse.length){
			...
			console.log($scope.parsedImages)
		}
	}

	$scope.retryErrors = function(images) {
